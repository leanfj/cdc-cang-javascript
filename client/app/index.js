System.register([], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      let campos = [document.querySelector('#data'), document.querySelector('#quantidade'), document.querySelector('#valor')];
